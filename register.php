...
<head>
    ...
    <title>The Wave Shop - Register</title>
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" id="lname" name="lname" max-length="30" class="form-control">
                            </div>
                            <div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="password" id="fname" name="fname" max-length="10" class="form-control">
                            </div>
                            <div class="form-group col-lg-12">
