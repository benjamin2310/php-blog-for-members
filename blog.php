        ...
        <div class="row">
            <div class="box">
                ...
                <h2 class="text-center">Welcome<?php echo $fname; echo " "; echo $lname; ?>- <a href="logout.php">Logout</a></h2>
                    <hr>
                    <h2 class="intro-text text-center">The Wave Shop
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    ...
                    <h2>COCONUT OIL COFFEE
                        <br>
                        <small>July 13, 2019</small>
                    </h2>
                    <p>Start your morning off with this great recipe for hot coffee coconut oil and butter.</p>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Take the edge off with a Fresh  hot cup of coffee made with Irish whiskey and Iris cream.</p>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">Read More</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/slide-3.jpg" alt="">
                    <h2>FROZEN CARAMEL LATTTE
                        <br>
                        <small>October 18, 2019</small>
                    </h2>
                    <p>Sweetned with caramel  sauce and topped with whipped cream, this will make you happy any time of the day.</p>
